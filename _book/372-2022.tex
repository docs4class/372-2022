...
\hypertarget{the-class-routine}{%
\chapter{The class routine}\label{the-class-routine}}

\textbf{Monday:} Wrap up previous topic and introduce what you've pre-read about. Chat. Play. Work some examples.

\textbf{Wednesday:} Work more examples. Chat as needed. Live our best lives. :).

\textbf{Friday:} Apply what we learned -- demonstrate your mastery. Rinse. Repeat.
